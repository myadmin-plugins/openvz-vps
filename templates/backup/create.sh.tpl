...
function iprogress() { curl --connect-timeout 60 --max-time 240 -k -d action=install_progress -d progress=$1 -d server={$id} 'https://myvps.interserver.net/vps_queue.php' < /dev/null > /dev/null 2>&1; }
iprogress 10 &
